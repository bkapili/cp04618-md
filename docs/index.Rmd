---
title: "<br> Taxonomic profiling of bacterial and archaeal communities from a CapScan-sampled gut metagenome"
output:
  html_document:
    df_print: paged
    toc: true
...
data <- log(x[, 1:nsamp], base = 10) %>% as.matrix
data[sapply(data, is.infinite)] <- NA
colnames(data) <- "EB_261 (CapScan)"
```
<br><br>
...
* *Faecalibacterium prausnitzii*:
  ...
  * Found at ~1% relative abundance in distal CapScan sample
<br><br>
